...
val appVersionCode: Int = System.getenv("VERSION_CODE")?.toIntOrNull() ?: 7
val appVersionName: String = "1.5"
...
android {
    ...
    signingConfigs {
        // If keystore.properties exists, load signing config for release
