 ...
 * Each pixel corresponds to one tile. Pixel colors are mapped to TerrainType
 * values.
 */
class TileMapLoader {
public:
  static std::optional<TileMapLoadResult>
  loadFromPng(AAssetManager *assetManager, const std::string &assetPath,
              float tileSize);
};
