...
public:
  ...
  /**
   * Generates an orthographic projection matrix given the half height, aspect
   * ratio, near, and far planes
   *
   ...
   * @return the generated matrix, this will be the same as @a outMatrix so you
   * can chain calls together if needed
   */
  static float *buildOrthographicMatrix(float *outMatrix, float halfHeight,
