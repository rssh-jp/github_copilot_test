...
void handle_cmd(android_app *pApp, int32_t cmd) {
  ...
  case APP_CMD_INIT_WINDOW:
    ...
    // this with a "game" class if that suits your needs. Remember to change all
    // instances of userData if you change the class here as a reinterpret_cast
    // is dangerous this in the android_main function and the
