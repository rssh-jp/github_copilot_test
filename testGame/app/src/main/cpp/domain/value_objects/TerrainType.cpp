...
constexpr TerrainProperties kForest{0.4f, true, 0.15f};
constexpr TerrainProperties kMountain{0.1f, true, 0.25f};
constexpr TerrainProperties kWater{0.0f, false, 0.0f};
constexpr TerrainProperties kRiver{0.0f, false, 0.05f};
